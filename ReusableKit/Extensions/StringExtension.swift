 ...
 *  Contains the extensions used for performing the commonly used functionalities relating to String that helps to perform string operations like validations
